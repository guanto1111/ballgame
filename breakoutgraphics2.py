...
class Win:
    def __init__(self):
        ...
        image = GImage.from_file("C:\\Users\\User\\OneDrive\\桌面\\Arial 獲勝畫面2.png")  # 圖片路徑需修改！！
...
class Gameover:
    def __init__(self):
        self.window = GWindow(width=500, height=700)
        image = GImage.from_file("C:\\Users\\User\\OneDrive\\桌面\\Arial game over畫面2.png")  # 圖片路徑需修改！！
        self.window.add(image)
...
class BreakoutGraphics:
    def __init__(self, ball_radius=BALL_RADIUS, paddle_width=PADDLE_WIDTH,
        ...
        # 圖片路徑需修改！！
        image_path = "C:\\Users\\User\\OneDrive\\桌面\\ghost.png" 
